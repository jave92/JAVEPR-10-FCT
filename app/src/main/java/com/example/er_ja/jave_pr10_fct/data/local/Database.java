...
import com.example.er_ja.jave_pr10_fct.data.local.entity.Proximas;
import com.example.er_ja.jave_pr10_fct.data.local.entity.Visita;

import androidx.room.Room;
import androidx.room.RoomDatabase;

@androidx.room.Database(entities = {Alumno.class, Empresa.class, Visita.class}, views = {Proximas.class}, version = 18)
public abstract class Database extends RoomDatabase {
    ...
    public abstract ProximasDao proximasDao();
